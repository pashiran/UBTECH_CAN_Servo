...
| 항목 | 사양 | 수량 | 비고 |
|------|------|------|------|
| UBTECH CAN 서보 | 60kg/25kg Type | 1~3개 | 다중 서보 테스트용 |
| Arduino Mega 2560 | - | 1개 | SPI 통신용 |
| MCP2515 CAN 모듈 | 8MHz 크리스탈 | 1개 | CAN 컨트롤러 |
| 전원 공급장치 | 24V 3A 이상 | 1개 | 서보 구동용 |
| 120Ω 저항 | 1/4W | 2개 | CAN 터미네이션 |
| 점퍼 케이블 | - | 15개 | 연결용 |
...
```cpp
/*
 * CAN_Basic_Communication_Test.ino
 * 
 * 단계 1: CAN 통신 기본 테스트
 * - CAN 버스 초기화
 * - 서보 응답 확인
...
// TODO: 타임아웃 설정 (2000ms)
// TODO: 버퍼 크기 정의 (16 bytes)
// TODO: 서보 ID 배열 (최대 10개)

// ============================================
// 2. 프레임 구조 정의
// ============================================
// TODO: 프레임 헤더 정의 (AA 00 00)
// TODO: 명령 코드 상수 정의
//   #define CMD_READ_INFO  0x01
//   #define CMD_MOVE       0x03
//   #define CMD_CHANGE_ID  0x07
//   #define CMD_LOCK       0x11
//   #define CMD_UNLOCK     0x2F
...
void setup() {
  ...
  Serial.println("=================================");
  Serial.println(" UBTECH CAN 서보 기본 테스트");
  Serial.println("=================================");
  
  // TEST-C-001: CAN 초기화
  Serial.println("\n[TEST-C-001] CAN 버스 초기화...");
  // TODO: CAN.begin() 호출
  // TODO: 성공/실패 확인
  // TODO: CAN.setMode(MCP_NORMAL) 설정
...
void loop() {
  Serial.println("\n--- 테스트 메뉴 ---");
  Serial.println("1. TEST-C-002: 서보 발견 (Ping)");
  Serial.println("2. TEST-C-003: 프레임 검증");
  Serial.println("3. 전체 테스트 실행");
  Serial.println("0. 테스트 종료");
...
// CAN 명령 전송 함수
bool sendCANCommand(byte servoId, byte cmd, byte* data, int dataLen) {
  // TODO: 첫 번째 프레임 구성 (헤더 + 길이 + ID)
  //   AA 00 00 [LEN] 00 00 00 [ID]
  // TODO: CAN.sendMsgBuf() 호출
  
  // TODO: 두 번째 프레임 구성 (명령 + 데이터)
  //   [CMD] [DATA...]
  // TODO: CAN.sendMsgBuf() 호출
...
// CAN 응답 수신 함수
bool receiveCANResponse(byte* buffer, int* length, int timeout) {
  unsigned long startTime = millis();
  
  // TODO: 타임아웃까지 대기
  // TODO: CAN.checkReceive() 확인
  // TODO: CAN.readMsgBuf() 호출
  // TODO: 헤더 검증 (AA 00 00)
  // TODO: 데이터 추출
...
// TEST-C-002: 서보 발견
void test_servo_discovery() {
  Serial.println("\n[TEST-C-002] 서보 발견 테스트");
  Serial.println("브로드캐스트로 서보 검색 중...");
  
  // TODO: ID=0으로 정보 읽기 명령 전송
  byte data[6] = {0x00};
  // TODO: sendCANCommand(0, CMD_READ_INFO, data, 6);
  
  // TODO: 2초 동안 응답 수신
  int foundCount = 0;
  unsigned long startTime = millis();
  
  // TODO: while (millis() - startTime < 2000)
  //   응답 확인 및 파싱
  //   서보 ID 저장
  //   위치 정보 출력
...
void test_frame_validation() {
  Serial.println("\n[TEST-C-003] 프레임 검증 테스트");
  
  // TODO: 특정 서보에 명령 전송 (ID=1)
  // TODO: 응답 수신
  // TODO: 헤더 확인 (AA 00 00)
  // TODO: 데이터 길이 확인
  // TODO: 결과 출력 (PASS/FAIL)
